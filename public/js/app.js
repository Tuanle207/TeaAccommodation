...
window.addEventListener('load', _map__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
function getAddressesPoints(currentCoords, radius) {
  var latitude = currentCoords.latitude,
      longitude = currentCoords.longitude;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("localhost:8000/api/apartments/latitude=".concat(latitude, "&longitude=").concat(longitude, "&radius=").concat(radius)).then(function (res) {
    var data = res.data.data;
    var dataForReturn = data.map(function (el) {
      return {
...
__webpack_require__(/*! C:\xampp\htdocs\TeaAccommodation\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\TeaAccommodation\resources\sass\main.scss */"./resources/sass/main.scss");
